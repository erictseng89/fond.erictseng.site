...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="CSS/購物車3.css" />
    ...
    <body>
        ...
        <main>
            ...
            <div class="contents">
                ...
                <div class="receiptBox">
                    <input type="radio" value="二聯式" name="receipt" id="receiptA">
                    <label for="receiptA">二聯式</label>
                    <input type="radio" value="三聯式" name="receipt" id="receiptB">
                    <label for="receiptB">三聯式</label>
                </div>
                <div id="receipt">
                    <span>公司抬頭</span>
        ...
        <script src="js/plugins/twzipcode.js"></script>
        <script src="js/plugins/jquery.twzipcode.min.js"></script>
