...
<head>
    <!-- CSS stylesheets -->
        ...
        <link rel="stylesheet" href="CSS/聯絡資訊.css">
    ...
    <main>
        <div class="bigBox">
            ...
            <p>
                電話: 04 1234 5678
                <br>
                Email: service@fondmomento.com.tw
                <br>
            ...
            <form>
                ...
                <span>連絡電話</span>
                <input type="tel" placeholder="電話" class="textinput">
                <span>電子信箱</span>
                <input type="email" placeholder="E-mail" class="textinput">
                <span>問題與意見</span>
                <textarea rows="5" cols="20"  class="textinput">

                </textarea>
                <input type="submit" value="確認送出" class="brownbutton">
            </form>
        </div>
