...
<head>
    <!-- CSS stylesheets -->
        ...
        <link rel="stylesheet" href="CSS/關於我們.css">
...
<body>
    ...
    <main>
        <div class="content">
            ...
            <div class="Box">
                <img src="images\aboutus\logo800px.png" >
            </div>
            <div class="Boxp">
                <p>品牌名稱：Fond Momento意寓為美好紀念</p>
                <P>讓消費者除了可直接在官網上設計想要的樣式之外，亦能夠透過線上拼圖小遊戲將結果製作成自已專屬的拼圖，讓此拼圖不只是禮物，更是記錄：銘記每一個不同凡響的日子，週年紀念，生日或是各種節日，留下當下最美好的樣子；本站提供個性化商品提供一個最好的平台，消費者所獲得將會是獨一無二的專屬化客製拼圖。</p>
            </div>
        ...
        <div class="content">
            ...
            <div class="ph-content">
                ...
                <div class="ph-Box">
                    <img src="images\portrait\頭像01.png" >
                    <p>Eric</p>
                </div>
                <div class="ph-Box">
                    <img src="images\portrait\頭像02.png" >
                    <p>Huang</p>
                </div>
                <div class="ph-Box">
                    <img src="images\portrait\頭像03.png" >
                    <p>Welsh Corgi</p>
                </div>
                <div class="ph-Box">
                    <img src="images\portrait\頭像04.png" >
                    <p>Ting</p>
                </div>
                <div class="ph-Box">
                    <img src="images\portrait\頭像05.png" >
                    <p>Chien Chien</p>
                </div>
            </div>
