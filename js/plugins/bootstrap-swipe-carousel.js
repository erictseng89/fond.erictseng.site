            ...
            function (require, module, exports) {
                (function (global) {
                    ...
                    var BootstrapSwipeCarousel = (function () {
                                    ...
                                    if (
                                        ...
                                        _this.debounceTimer = setTimeout(
                                            function () {
                                                ...
                                                _this.processCarouselSlideQueue(
                                                    targetCarousel
                                                );
                                            },
                                            DEBOUNCE_TIMEOUT
                                ...
                                [
                                    ...
                                    },
                                    {
                                        ...
                                        value: function processCarouselSlideQueue(
                                            ...
                                            if (queue.length > 0) {
                                                var _queue = _slicedToArray(
                                                        queue,
                                                        1
                                                    ),
                                                    itemToProcess = _queue[0];
                                                targetCarouselEl.carousel(
                                                    itemToProcess.action
                                                );
                                            }
                                        },
                                    },
                        ...
                        SwipeCarousel.jQueryModule = function jQueryInterface(
                            config
                        ) {
                            return this.each(function addModuleWrapper() {
                                var swipeCarousel = (0, _jquery2.default)(
                                    this
                                ).data(CAROUSEL_DATA_KEY);
                                if (
