...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="CSS/對對碰.css" />
    ...
    <body>
        ...
        <main>
            <h1>🐋金魚腦記憶🐋</h1>
            <p>
                請輸入您想要玩幾對再按『開始玩!』按鈕，並逐一兩兩翻閱每張牌，若連續翻起的兩張牌均相同，則可取走此兩張牌，否則電腦會自動蓋回，直到所有牌均取完為止。
            </p>
            <form action="javascript:startPlaying()">
                要玩幾對?
                <input class="textinput" type="text" id="cardPlayBox" placeholder="1~52" />
                &nbsp;
                <button class="brownbutton" type="submit">開始玩!</button>
            </form>
            <div class="gameBox"></div>
            <br />
            <div id="controlForm" class="gameControl">
                <button
                    class="brownbutton"
                    type="submit"
                    name="start"
                ...
                您一共使用
                <input class="textinput" type="text" id="timerBox" />
                秒
                <button
                    id="hintB"
                    class="brownbutton"
